...
from .views import index, DocumentListView, DocumentCreateView, DocumentDetailView, \
    DocumentDeleteView, DocumentUpdateView, AssistantListView, AssistantCreateView, AssistantDetailView, \
    AssistantDeleteView, AssistantUpdateView
...
urlpatterns = [
    ...
    path("assistants/add", AssistantCreateView.as_view(), name="assistant_create"),
    path("assistants/<str:pk>/", AssistantDetailView.as_view(), name="assistant_detail"),
    path("assistants/<str:pk>/delete", AssistantDeleteView.as_view(), name="assistant_delete"),
    path("assistants/<str:pk>/update", AssistantUpdateView.as_view(), name="assistant_update"),
